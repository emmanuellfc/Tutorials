...
# ╔═╡ f940aa72-867c-4e1d-9b16-b46169d774af
using ModelingToolkit, DifferentialEquations, Plots

# ╔═╡ fb09e999-49cc-4d94-a74c-b865fedeb1d6
# Define our state variables: state(t) = initial condition
@variables t x(t)=1 y(t)=1 z(t)=2

# ╔═╡ 06cfbcaa-a559-441b-8517-bd18458e285f
# Define our parameters
@parameters α=1.5 β=1.0 γ=3.0 δ=1.0

# ╔═╡ 7e0c59c9-0dd7-4ec8-8dc2-a8a978b4b6c5
# Define our differential: takes the derivative with respect to `t`
D = Differential(t)

# ╔═╡ efbf82af-c1cf-4634-b13d-fe08df7a1ed1
# Define the differential equations
eqs = [D(x) ~ α * x - β * x * y
       D(y) ~ -γ * y + δ * x * y
       z ~ x + y]

# ╔═╡ 1950e23a-912a-4894-a750-20d1928951ab
# Bring these pieces together into an ODESystem with independent variable t
@named sys = ODESystem(eqs, t)

# ╔═╡ e36637e8-f1aa-41df-ab64-ae8c4b8ff03b
# Symbolically Simplify the System
simpsys = structural_simplify(sys)

# ╔═╡ 7fefedf7-f529-4406-9951-c2d23a471c72
# Convert from a symbolic to a numerical problem to simulate
tspan = (0.0, 10.0)

# ╔═╡ 09d837b9-3c3e-4d70-be2a-7ca15f173d68
prob = ODEProblem(simpsys, [], tspan)

# ╔═╡ 94964570-3451-44bb-b403-6306a9ada0b1
# Solve the ODE
sol = solve(prob)

# ╔═╡ b608dcf6-fe78-45b9-a98e-3e03661b1613
# Plot the solution
p1 = plot(sol, title = "Rabbits vs Wolves")

# ╔═╡ cbaf556c-87a0-4966-92b8-36a7cde5f90f
p2 = plot(sol, idxs = z, title = "Total Animals")

# ╔═╡ 802bf815-23e3-46a4-a8fa-3462068c37b7
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "fdd65ccf72b1a02c2d041f8f14ca41acd89e3f03"
