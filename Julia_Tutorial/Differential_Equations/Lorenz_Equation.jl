...
# ╔═╡ b9f4f032-f5d5-11ed-3af7-2bfac1a5e1e2
...
# ╔═╡ 49454e14-cb1a-429d-8c4b-8c1b61fe4aae
md"""
**Systems of ODEs: The Lorenz Equation**

Source: https://docs.sciml.ai/DiffEqDocs/stable/getting_started/#ode_example
"""

# ╔═╡ 00ef890b-fdcc-4324-9bd4-3a4e2e7b70f6
latexify("dx/dt = s(y-x)")

# ╔═╡ aa924d25-0e46-427f-b6c7-8a40a0dacf3a
latexify("dy/dt = x(p-z)-y")

# ╔═╡ 47237456-7c91-4b7a-966a-86a76dcffa01
latexify("dz/dt = xy-bz")

# ╔═╡ 66c4f560-7516-4b89-b653-4a4393660671
...
# ╔═╡ f47c8c51-2089-4b18-8660-9c95a1484788
# Setting initial conditions
u0 = [1.0, 0.0, 0.0]

# ╔═╡ b92b4eec-6cdf-4c53-a5f3-0ef93b5c16eb
# Set time span and declare the problem
begin
	tspan = (0.0, 100.0)
...
# ╔═╡ acae32a8-de49-41c6-a03f-4e00c4baffb7
plot(sol)

# ╔═╡ b48f00f7-1849-4dbb-b7ff-c42dabfadd05
plot(sol, idxs=(1,2,3))

# ╔═╡ e2df6efc-89ed-4b72-851b-99b62ef07cce
