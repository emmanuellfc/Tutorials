...
md"""
Our first model is going to be the canonical exponential growth. This model says that the rate of change is proportional to the current value, so we will have:
"""
...
# ╔═╡ 750f90a4-adb9-421b-8043-df09eb4c0b5d
sol = solve(prob)

# ╔═╡ b88cba7f-b71f-451a-9b63-4c152612dee7
plot(sol, linewidth = 2.5,
	 title = "Solution to the linear ODE",
	 xaxis = "Time (t)",
	 yaxis = "u(t)",
	 label = "Approximated solution")

# ╔═╡ 41cdb951-d839-4246-9948-334889757807
md"""
Now let's plot the analytical solution:
"""

# ╔═╡ bb6320d9-7bdd-4efd-afaf-5f1f74bfdc4a
plot!(sol.t, t->1.0*exp(0.98t), lw = 2.5, ls=:dash, label = "Analytical solution")

# ╔═╡ ca608acd-2d86-4e77-a026-8458327371c7
md"""
The syntax **sol.t** grabs the array of time points the solution was saved at:
"""

# ╔═╡ 3ab3729c-d694-4a2e-9715-9a4eaa4cc535
sol.t
