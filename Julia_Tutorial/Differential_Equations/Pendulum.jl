...
# ╔═╡ 70dfcfb5-c5a2-4597-b5db-47b68591db9c
begin
...
# ╔═╡ f90b4794-f648-11ed-01b4-5505a88aafeb
md"""
...
# ╔═╡ ec673451-fd87-44b5-a1e7-8826d65fe690
md"""
Parameterized functions can also be used for building nonhomogeneous ordinary differential equations (these are also referred to as ODEs with nonzero right-hand sides). They are frequently used as models for dynamical systems with external (in general time-varying) inputs.

consider a model of a pendulum consisting of a slender rod of length l and mass m:
"""

# ╔═╡ d07fd5cb-b6ef-4cf3-9007-57a410276b85
latexify("dθ(t)/dt = ω(t)")

# ╔═╡ 1155bc1c-b0f2-45c5-9932-fed858abdb0e
latexify("dω(t)/dt = -3g/(2l)*sin(θ(t)) + 3/(ml^2)*M(t)")

# ╔═╡ f4231cf6-1c0f-4215-b242-4b7af03c5ba4
md"""
...
# ╔═╡ df612601-0851-4541-8ca3-6053cb6be782
...
# ╔═╡ 55ee9466-aeb0-41da-8152-ceda5adc2d79
# Define the problem for the differential equation
function pendulum!(du, u, p, t)
	du[1] = u[2]
	du[2] = -(3/2)*(g/l)*sin(u[1]) + (3/m*l^2)*p(t)
end

# ╔═╡ b2f0e987-fc3f-41a4-b279-8c333367af9c
...
begin
	...
	u₀ = [θ₀, ω₀];
	tspan = (0.0, 10.0);
	M = t-> 0.1sin(t)     # Define external torque
end

# ╔═╡ b2a3c937-6a63-4ba1-838c-8bc3d8af1159
# Solve the problem
begin
...
# ╔═╡ 577f2ae3-a590-4c7b-acd5-f0dbe713ef77
# Plot the solution
plot(sol, lw = 2, xaxis = "Time", label = ["θ [rad]" "ω [rad/s]"], layout = (2 ,1))

# ╔═╡ e4a3168a-f3bb-44b8-a1ce-8114e0f0e5dc
md"""
