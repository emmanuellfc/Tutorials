...
# ╔═╡ 3a463b9b-2e91-48ee-bec4-f5dacceaf34a
begin
	using Plots
	x = range(0, 2pi, length=100)
	y = sin.(x)
	plt = plot(plot(x,y), scatter(x, y), bar(x, y))
end

# ╔═╡ 9f9b2776-e142-11ed-2a11-5df983a880da
md"**The Julia Package Ecosystem**"

# ╔═╡ 9befe6de-6793-4ede-ad17-8c3426fe910b
md"In this chapter, we're going to cover the following main topics:
...
# ╔═╡ 960eb95d-3360-467c-a533-70b081189a48
md"
...
* InspectDR: It doesn't support many Plots features, focusing on line and scatter plots. It is fast, allowing interaction with the plot: pan, zooming, coordinate display, and adding markers to measure distances and slopes.
* Gaston: It is fast, but it misses some Plots features. You gain access to the Gnuplot GUI.
"

# ╔═╡ a602ffad-f7a4-4f49-a0c1-2c674e4d8e7b
backend()
