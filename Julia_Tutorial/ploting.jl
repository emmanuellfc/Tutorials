...
# ╔═╡ b5dce541-a08a-446f-8fb3-a767bd7fc34a
x = rand(0:1, 25);

# ╔═╡ dc85bef6-65dd-4914-836a-ad9556dbe7ca
y = rand(0:1, 25);

# ╔═╡ e0fa93a9-8851-4688-8d97-801736e20696
?hcat

# ╔═╡ 3e8423a3-736c-45b8-8ce3-6d1db5b310ab
begin
	plot(x, y, title = "Random Plot")
	plot(y, x, title = "Inverse Random Plot")
end
...
plot(years, apples, title = "Apples per year")
...
plot(years, apples, legend=false, grid = true, title="Number of apples per year")
...
scatter(apples, oranges, legend=false, grid = true)
...
begin
	plot(years, fruits, layout=(2, 2), legend=false)
	plot!(title = "Subplots")
end
...
plot(apples_plot, apples_vs_oranges, layout=(1, 2), title = "Comparisson")
